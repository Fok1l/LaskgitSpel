...
public class URB : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (ifollow == true)
        {
            ...
            if (Input.GetMouseButtonUp(0))
            {
                ...
                {
                    if (collider.CompareTag("UpperRightSlot") && blade.GetComponent<Collider2D>().enabled) //if mouse is inside the collider: && collider.bounds.Contains(mouseWorldPos)
                    {
